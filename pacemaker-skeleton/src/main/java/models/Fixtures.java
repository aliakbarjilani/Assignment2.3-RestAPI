...
public class Fixtures {
  ...
  public static List<User> users =
      new ArrayList<>(Arrays.asList(new User("marge", "simpson", "marge@simpson.com", "secret"),
          new User("ali", "jilani", "ali@wit.ie", "secret"),
          new User("guy1", "simpson", "guy1@simpson.com", "secret"),
          new User("guy2", "simpson", "guy2@simpson.com", "secret"),
          new User("guy3", "simpson", "guy3@simpson.com", "secret"),
